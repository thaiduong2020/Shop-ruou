...
<?php 
  $hang_cung_loai = $conn-> prepare("SELECT * FROM products WHERE type_id = $row[3] ORDER BY RAND() limit 5");
 ...
 foreach($hang_cung_loai as $row){?>
    ...
    height: 100%;">
        <div class="overlay">
           ...
           <a  href="#"><button type="button" onclick="addCart( <?php echo $row[0]?>)"   style="width:52%" class="btn btn-danger">MUA NGAY</button>
</a>
